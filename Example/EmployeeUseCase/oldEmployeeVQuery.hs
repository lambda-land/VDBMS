...
-- | fold a list of query/algebra into one variational query/algebra 
...
pushFeatureToAlgebra f (AChc  v  l  r) = error "Shouldn't have AChc in plain query/Algebra"  
...
mergeAlgebraFeature a                     (SetOp op l r)    = undefined -- ?  
...
-- SELECT * FROM D,E
testq4 = pushFeatureToAlgebra v4 $ SetOp Prod (TRef (Relation "D")) (TRef (Relation "E"))
