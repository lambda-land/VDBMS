...
Proof.
  ...
  intro x0. unfold t_update. unfold eqb_string.
  destruct string_dec as [Hl | Hr].
...
Proof.
  ...
  intro x0. unfold t_update. destruct (eqb_stringP x x0).
...
Proof.
  ...
  intro x. unfold t_update. destruct (eqb_stringP x1 x).
  - destruct (eqb_stringP x2 x). 
    + rewrite<-e0 in e. symmetry in e. rewrite e in H. destruct H.
      reflexivity.
    + reflexivity.
  - destruct (eqb_stringP x2 x). 
    + reflexivity. 
