# create a view for engineerpersonnel in variant 1
...
# create a view for otherpersonnel in variant 1
...
# create a view for empacct of variant 2 : 
...
# create a view for empacct of variant 3
...
# create a view for empacct of variant 4
...
# create a view for empacct of variant 5
...
# create a view for empbio of variant 4
...
# create a view for empbio of variant 5
# SELECT count( emp.emp_no) -- 240124
...
# create a view for dept of variant 3
...
# create a view for dept of variant 4
...
# create a view for dept of variant 5
Create OR REPLACE view v5_dept_view AS 
SELECT dept_name as deptname, dept.dept_no as deptno, dept_manager.emp_no as managerno
FROM dept_manager  
JOIN departments dept on dept.dept_no = dept_manager.dept_no
JOIN employees emp on emp.emp_no = dept_manager.emp_no
