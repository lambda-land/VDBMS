...
empQ1_v4and5 = Proj [(F.Lit True, Attribute "empno"),
                     (F.And (F.Ref $ Feature "v4") (F.Not $ F.Ref $ Feature "v5"), Attribute "name"),
                     (F.And (F.Not $ F.Ref $ Feature "v4") (F.Ref $ Feature "v5"), Attribute "firstname"),
                     (F.And (F.Not $ F.Ref $ Feature "v4") (F.Ref $ Feature "v5"), Attribute "lastname"),
